    ...
    return (
        <div className={style.divDet}>
            ...
            <div className={style.divCont}>
                ...
                <div className={style.divTxD}>
                    <h3 className={style.h3d}>Height: {detail?.height}</h3>
                </div>
                <div className={style.divTxD}>
                    <h3 className={style.h3d}>Weight Min: {detail?.weightMin}</h3>
                </div>
                <div className={style.divTxD}>
                    <h3 className={style.h3d}>Weight Max:{detail?.weightMax}</h3>
                </div>
                <div className={style.divTxD}>
